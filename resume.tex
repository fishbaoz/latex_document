...
\item Bringing up and Porting coreboot to more than 20 reference design cases include blade storage server (SBB), Set-To-Box (STB), 6-screen digital signage, NAS, low-cost PC and public reference boards covered 7 generations AMD APU and server CPU.
\item Successively promoted as Senior Engineer, MTS, SMTS for extensive contribute to both firmware development and hardware bringing up
\end{rSubsection}
